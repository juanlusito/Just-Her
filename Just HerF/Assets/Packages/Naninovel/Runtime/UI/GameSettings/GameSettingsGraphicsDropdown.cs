...
namespace Naninovel.UI
{
    public class GameSettingsGraphicsDropdown : ScriptableDropdown
    {
        ...
        protected static string GraphicOption1 = "Mínima";
        [ManagedText("DefaultUI")]
        protected static string GraphicOption2 = "Baja";
        [ManagedText("DefaultUI")]
        protected static string GraphicOption3 = "Media";
        [ManagedText("DefaultUI")]
        protected static string GraphicOption4 = "Alta";
        [ManagedText("DefaultUI")]
        protected static string GraphicOption5 = "Muy alta";
        [ManagedText("DefaultUI")]
