...
namespace Naninovel.UI
{
    public class GameSettingsScreenModeDropdown : ScriptableDropdown
    {
        ...
        protected static string ExclusiveFullScreen = "Pantalla completa";
        [ManagedText("DefaultUI")]
        protected static string FullScreenWindow = "Ventana sin bordes";
        [ManagedText("DefaultUI")]
        protected static string MaximizedWindow = "Ventana maximizada";
        [ManagedText("DefaultUI")]
        protected static string Windowed = "Ventana";
