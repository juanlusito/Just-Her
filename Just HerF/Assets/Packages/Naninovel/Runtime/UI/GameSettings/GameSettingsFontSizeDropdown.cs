...
namespace Naninovel.UI
{
    public class GameSettingsFontSizeDropdown : ScriptableDropdown
    {
        ...
        protected static string Small = "Pequeño";
        [ManagedText("DefaultUI")]
        protected static string Default = "Predeterminado";
        [ManagedText("DefaultUI")]
        protected static string Large = "Grande";
        [ManagedText("DefaultUI")]
        protected static string ExtraLarge = "Muy grande";
